    ...
    return (
        <div className='px-5 md:px-10 mt-10'>
            <div className='flex flex-col items-center pb-5'>
                ...
                <p className='py-4'>What make us special to be choosen by our clients</p>
            </div>
                    ...
                    <div className='pt-10 px-0 md:px-5 flex flex-col gap-y-5'>
                        <div className='flex items-center gap-x-2'>
                            ...
                            <div className='text-sm'>
                                <p className='font-semibold text-sm md:text-xl mb-1'>Save time</p>
                                <p>
                        ...
                        <div className='flex items-center gap-x-2'>
                            ...
                            <div className='text-sm'>
                                <p className='font-semibold text-sm md:text-xl mb-1'>Low cost</p>
                                <p>
                        ...
                        <div className='flex items-center gap-x-2'>
                            ...
                            <div className='text-sm'>
                                <p className='font-semibold text-sm md:text-xl mb-1'>Deliver high quality</p>
                                <p>
                        ...
                        <button className='hidden md:block px-6 py-2 w-32 text-white bg-blue-600 font-semibold rounded-md text-sm my-5'>Book now</button>
                    </div>
